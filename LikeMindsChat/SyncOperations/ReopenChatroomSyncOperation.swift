...
class ReopenDMChatroomSyncOperation {
    ...
    private var chatroomTypes: [Int]
    private static let shared: ReopenDMChatroomSyncOperation = ReopenDMChatroomSyncOperation(chatroomTypes: [10])
    
    static func sharedInstance(chatroomTypes: [Int] = [10]) -> ReopenDMChatroomSyncOperation {
        shared.page = 1
        shared.chatroomTypes = chatroomTypes
        shared.maxTimestamp = Int(Date().timeIntervalSince1970)
