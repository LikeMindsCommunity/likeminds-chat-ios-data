...
class ROConverter {
  ...
  static func convertConversation(
    ...
    if conversation.widget != nil {
      let widgetRO = convertWidgetToRO(conversation.widget!)
  ...
  static func convertConversation(
    ...
    if conversation.widgetId != nil && !conversation.widgetId!.isEmpty {
      ...
      let widgetRO = convertWidgetToRO(widget)
      conversationRO.widget = widgetRO
    }
    return conversationRO
  }
  ...
  static func convertLastConversation(
    ...
    if let widget = conversation.widget {
      lastConversationRO.widget = convertWidgetToRO(widget)
    }
  ...
  /// Converts a Widget object to a Realm WidgetRO object
  /// - Parameter widget: Widget object to be converted
  /// - Returns: A Realm WidgetRO object
  static func convertWidgetToRO(_ widget: Widget?) -> WidgetRO? {
    ...
    widgetRO.lmMeta = convertLMMetaToRO(widget.lmMeta)
  ...
  /// Converts an LMMeta object to a Realm LMMetaRO object
  /// - Parameter lmMeta: LMMeta object to be converted
  /// - Returns: A Realm LMMetaRO object
  static func convertLMMetaToRO(_ lmMeta: LMMeta?) -> LMMetaRO? {
    guard let lmMeta = lmMeta else { return nil }

    let lmMetaRO = LMMetaRO()
    lmMetaRO.sourceChatroomId = lmMeta.sourceChatroomId
    lmMetaRO.sourceChatroomName = lmMeta.sourceChatroomName
    lmMetaRO.sourceConversation = convertConversation(conversation: lmMeta.sourceConversation)
    lmMetaRO.type = lmMeta.type
