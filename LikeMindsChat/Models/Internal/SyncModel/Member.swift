...
public struct Member: Codable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(userUniqueId, forKey: .userUniqueId)
    ...
    try container.encodeIfPresent(customIntroText, forKey: .customIntroText)
    try container.encodeIfPresent(customClickText, forKey: .customClickText)
    ...
    try container.encodeIfPresent(attendingStatus, forKey: .attendingStatus)
    try container.encodeIfPresent(hasProfileImage, forKey: .hasProfileImage)
    try container.encodeIfPresent(updatedAt, forKey: .updatedAt)
    try container.encodeIfPresent(sdkClientInfo, forKey: .sdkClientInfo)
