...
public class Conversation: Codable {
  ...
  public required init(from decoder: Decoder) throws {
    ...
    attachmentUploadedEpoch = try container.decodeIfPresent(
      Int.self, forKey: .attachmentUploadedEpoch)
  }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(replyConversationId, forKey: .replyConversationId)
    try container.encodeIfPresent(deletedBy, forKey: .deletedBy)
    try container.encodeIfPresent(createdEpoch, forKey: .createdEpoch)
    try container.encodeIfPresent(attachmentCount, forKey: .attachmentCount)
    try container.encodeIfPresent(attachmentUploaded, forKey: .attachmentUploaded)
    try container.encodeIfPresent(uploadWorkerUUID, forKey: .uploadWorkerUUID)
    try container.encodeIfPresent(temporaryId, forKey: .temporaryId)
    try container.encodeIfPresent(localCreatedEpoch, forKey: .localCreatedEpoch)
    try container.encodeIfPresent(reactions, forKey: .reactions)
    try container.encodeIfPresent(isAnonymous, forKey: .isAnonymous)
    try container.encodeIfPresent(allowAddOption, forKey: .allowAddOption)
    try container.encodeIfPresent(pollType, forKey: .pollType)
    try container.encodeIfPresent(pollTypeText, forKey: .pollTypeText)
    try container.encodeIfPresent(submitTypeText, forKey: .submitTypeText)
    try container.encodeIfPresent(expiryTime, forKey: .expiryTime)
    try container.encodeIfPresent(multipleSelectNum, forKey: .multipleSelectNum)
    try container.encodeIfPresent(multipleSelectState, forKey: .multipleSelectState)
    try container.encodeIfPresent(polls, forKey: .polls)
    try container.encodeIfPresent(toShowResults, forKey: .toShowResults)
    try container.encodeIfPresent(pollAnswerText, forKey: .pollAnswerText)
    try container.encodeIfPresent(replyChatroomId, forKey: .replyChatroomId)
    try container.encodeIfPresent(deviceId, forKey: .deviceId)
    try container.encodeIfPresent(hasFiles, forKey: .hasFiles)
    try container.encodeIfPresent(hasReactions, forKey: .hasReactions)
    try container.encodeIfPresent(lastUpdated, forKey: .lastUpdated)
    try container.encodeIfPresent(deletedByMember, forKey: .deletedByMember)
    try container.encodeIfPresent(replyConversation, forKey: .replyConversation)
    try container.encodeIfPresent(conversationStatus, forKey: .conversationStatus)
    try container.encode(widgetId, forKey: .widgetId)
    try container.encodeIfPresent(widget, forKey: .widget)
    try container.encodeIfPresent(attachmentUploadedEpoch, forKey: .attachmentUploadedEpoch)
  }
