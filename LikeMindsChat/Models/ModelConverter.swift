...
class ModelConverter {
  ...
  private func convertAttachmentRO(_ attachmentRO: AttachmentRO) -> Attachment {
    return Attachment.Builder()
      ...
      .type(
        Attachment.AttachmentType(rawValue: attachmentRO.type ?? "")
  ...
  /// Converts a Realm LMMetaRO object to an LMMeta object
  /// - Parameter lmMetaRO: Realm LMMetaRO object to be converted
  /// - Returns: An LMMeta object
  private func convertLMMetaRO(_ lmMetaRO: LMMetaRO?) -> LMMeta? {
    guard let lmMetaRO = lmMetaRO else { return nil }
  ...
  /// Converts a Realm WidgetRO object to a Widget object
  /// - Parameter widgetRO: Realm WidgetRO object to be converted
  ...
  func convertWidgetROToWidget(_ widgetRO: WidgetRO) -> Widget? {
    ...
    if let metadataData = widgetRO.metadata {
      do {
        metadataDict = try JSONSerialization.jsonObject(with: metadataData) as? [String: Any]
      } catch {
